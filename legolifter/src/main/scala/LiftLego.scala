...
object LiftLego {
  def main(args: Array[String]): Unit = {
    println("Generation of the legobase deep embedding!")
  ...
  def generateNumber(implicit al: AutoLifter): Unit = {
...
""")
  ...
  def generateLegoBase(implicit al: AutoLifter): Unit = {
...
""")
  ...
  def generateCollection(implicit al: AutoLifter): Unit = {
    val liftedCodes = List(
