...
""")
  ...
  def generateCLibs(implicit al: AutoLifter) {
    val liftedCodes = List(
      al.autoLift[ch.epfl.data.pardis.shallow.c.CPointerType[_]](Custom("CLibs")),
      al.autoLift[ch.epfl.data.pardis.shallow.c.CLangTrait](Custom("CLibs")),
      al.autoLift[ch.epfl.data.pardis.shallow.c.CStdLibTrait](Custom("CLibs")),
      al.autoLift[ch.epfl.data.pardis.shallow.c.CStdIOTrait](Custom("CLibs")),
      //al.autoLift[ch.epfl.data.pardis.shallow.c.CSysTimeTrait],
      al.autoLift[ch.epfl.data.pardis.shallow.c.CStringTrait](Custom("CLibs")),
      al.autoLift[ch.epfl.data.pardis.shallow.c.GArrayTrait](Custom("CLibs")),
      al.autoLift[ch.epfl.data.pardis.shallow.c.GListType[_]](Custom("CLibs")),
      al.autoLift[ch.epfl.data.pardis.shallow.c.GListTrait](Custom("CLibs")),
      al.autoLift[ch.epfl.data.pardis.shallow.c.GTreeTrait](Custom("CLibs")),
      al.autoLift[ch.epfl.data.pardis.shallow.c.GHashTableType[_, _]](Custom("CLibs")),
      al.autoLift[ch.epfl.data.pardis.shallow.c.GHashTableTrait](Custom("CLibs")))
    val liftedCode = liftedCodes.mkString("\n")
    val file = "GLib"
    printToFile(new java.io.File(s"$folder/scalalib/$file.scala")) { pw =>
      pw.println(s"""/* Generated by AutoLifter © ${new GregorianCalendar().get(Calendar.YEAR)} */
