...
trait CLangOps extends Base { this: CLibs =>
  ...
  object CLang {
    ...
    def as[T](x: Rep[Any])(implicit typeT: TypeRep[T], evidence$19: CType[T]): Rep[T] = cLangAsObject[T](x)(typeT, evidence$19)
  ...
  case class CLangAsObject[T](x: Rep[Any])(implicit val typeT: TypeRep[T], val evidence$19: CType[T]) extends FunctionDef[T](None, "CLang.as", List(List(x))) {
    override def curriedConstructor = (copy[T] _)
  }
  ...
  def cLangAsObject[T](x: Rep[Any])(implicit typeT: TypeRep[T], evidence$19: CType[T]): Rep[T] = CLangAsObject[T](x)
...
trait LGHashTableOps extends Base { this: CLibs =>
  // Type representation
  case object LGHashTableType extends TypeRep[LGHashTable] {
    def rebuild(newArguments: TypeRep[_]*): TypeRep[_] = LGHashTableType
    val name = "LGHashTable"
    val typeArguments = Nil

    val typeTag = scala.reflect.runtime.universe.typeTag[LGHashTable]
  }
  implicit val typeLGHashTable: TypeRep[LGHashTable] = LGHashTableType
  implicit class LGHashTableRep[K, V](self: Rep[LGHashTable])(implicit typeK: TypeRep[K], typeV: TypeRep[V]) {
  ...
  type LGHashTable = ch.epfl.data.pardis.shallow.c.GLibTypes.LGHashTable
}
...
trait LGHashTableHeaderOps extends Base { this: CLibs =>
  ...
  object LGHashTableHeader {
    def g_hash_table_new(hash: Rep[LPointer[(LPointer[Any] => Int)]], equals: Rep[LPointer[((LPointer[Any], LPointer[Any]) => Int)]]): Rep[LPointer[LGHashTable]] = lGHashTableHeaderG_hash_table_newObject(hash, equals)
    def g_hash_table_insert(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]], value: Rep[LPointer[Any]]): Rep[Unit] = lGHashTableHeaderG_hash_table_insertObject(ht, key, value)
    def g_hash_table_replace(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]], value: Rep[LPointer[Any]]): Rep[Unit] = lGHashTableHeaderG_hash_table_replaceObject(ht, key, value)
    def g_hash_table_size(ht: Rep[LPointer[LGHashTable]]): Rep[Int] = lGHashTableHeaderG_hash_table_sizeObject(ht)
    def g_hash_table_lookup(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]]): Rep[LPointer[Any]] = lGHashTableHeaderG_hash_table_lookupObject(ht, key)
    def g_hash_table_lookup_extended(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]], origKey: Rep[LPointer[Any]], value: Rep[LPointer[Any]]): Rep[Int] = lGHashTableHeaderG_hash_table_lookup_extendedObject(ht, key, origKey, value)
    def g_hash_table_foreach(ht: Rep[LPointer[LGHashTable]], func: Rep[LPointer[((LPointer[Any], LPointer[Any], LPointer[Any]) => Unit)]], userData: Rep[Any]): Rep[Unit] = lGHashTableHeaderG_hash_table_foreachObject(ht, func, userData)
    def g_hash_table_find(ht: Rep[LPointer[LGHashTable]], pred: Rep[LPointer[((LPointer[Any], LPointer[Any], LPointer[Any]) => Int)]], userData: Rep[Any]): Rep[LPointer[Any]] = lGHashTableHeaderG_hash_table_findObject(ht, pred, userData)
    def g_hash_table_remove(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]]): Rep[Int] = lGHashTableHeaderG_hash_table_removeObject(ht, key)
    def g_hash_table_remove_all(ht: Rep[LPointer[LGHashTable]]): Rep[Unit] = lGHashTableHeaderG_hash_table_remove_allObject(ht)
    def g_hash_table_foreach_remove(ht: Rep[LPointer[LGHashTable]], pred: Rep[LPointer[((LPointer[Any], LPointer[Any], LPointer[Any]) => Int)]], userData: Rep[Any]): Rep[Int] = lGHashTableHeaderG_hash_table_foreach_removeObject(ht, pred, userData)
    def g_hash_table_get_keys(ht: Rep[LPointer[LGHashTable]]): Rep[LPointer[LGList[Any]]] = lGHashTableHeaderG_hash_table_get_keysObject(ht)
    def g_hash_table_get_values(ht: Rep[LPointer[LGHashTable]]): Rep[LPointer[LGList[Any]]] = lGHashTableHeaderG_hash_table_get_valuesObject(ht)
  }
  // constructors

  // case classes
  case class LGHashTableHeaderG_hash_table_newObject(hash: Rep[LPointer[(LPointer[Any] => Int)]], equals: Rep[LPointer[((LPointer[Any], LPointer[Any]) => Int)]]) extends FunctionDef[LPointer[LGHashTable]](None, "LGHashTableHeader.g_hash_table_new", List(List(hash, equals))) {
    override def curriedConstructor = (copy _).curried
  }

  case class LGHashTableHeaderG_hash_table_insertObject(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]], value: Rep[LPointer[Any]]) extends FunctionDef[Unit](None, "LGHashTableHeader.g_hash_table_insert", List(List(ht, key, value))) {
    override def curriedConstructor = (copy _).curried
  }

  case class LGHashTableHeaderG_hash_table_replaceObject(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]], value: Rep[LPointer[Any]]) extends FunctionDef[Unit](None, "LGHashTableHeader.g_hash_table_replace", List(List(ht, key, value))) {
    override def curriedConstructor = (copy _).curried
  }

  case class LGHashTableHeaderG_hash_table_sizeObject(ht: Rep[LPointer[LGHashTable]]) extends FunctionDef[Int](None, "LGHashTableHeader.g_hash_table_size", List(List(ht))) {
    override def curriedConstructor = (copy _)
  }

  case class LGHashTableHeaderG_hash_table_lookupObject(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]]) extends FunctionDef[LPointer[Any]](None, "LGHashTableHeader.g_hash_table_lookup", List(List(ht, key))) {
    override def curriedConstructor = (copy _).curried
  }

  case class LGHashTableHeaderG_hash_table_lookup_extendedObject(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]], origKey: Rep[LPointer[Any]], value: Rep[LPointer[Any]]) extends FunctionDef[Int](None, "LGHashTableHeader.g_hash_table_lookup_extended", List(List(ht, key, origKey, value))) {
    override def curriedConstructor = (copy _).curried
  }

  case class LGHashTableHeaderG_hash_table_foreachObject(ht: Rep[LPointer[LGHashTable]], func: Rep[LPointer[((LPointer[Any], LPointer[Any], LPointer[Any]) => Unit)]], userData: Rep[Any]) extends FunctionDef[Unit](None, "LGHashTableHeader.g_hash_table_foreach", List(List(ht, func, userData))) {
    override def curriedConstructor = (copy _).curried
  }

  case class LGHashTableHeaderG_hash_table_findObject(ht: Rep[LPointer[LGHashTable]], pred: Rep[LPointer[((LPointer[Any], LPointer[Any], LPointer[Any]) => Int)]], userData: Rep[Any]) extends FunctionDef[LPointer[Any]](None, "LGHashTableHeader.g_hash_table_find", List(List(ht, pred, userData))) {
    override def curriedConstructor = (copy _).curried
  }

  case class LGHashTableHeaderG_hash_table_removeObject(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]]) extends FunctionDef[Int](None, "LGHashTableHeader.g_hash_table_remove", List(List(ht, key))) {
    override def curriedConstructor = (copy _).curried
  }

  case class LGHashTableHeaderG_hash_table_remove_allObject(ht: Rep[LPointer[LGHashTable]]) extends FunctionDef[Unit](None, "LGHashTableHeader.g_hash_table_remove_all", List(List(ht))) {
    override def curriedConstructor = (copy _)
  }

  case class LGHashTableHeaderG_hash_table_foreach_removeObject(ht: Rep[LPointer[LGHashTable]], pred: Rep[LPointer[((LPointer[Any], LPointer[Any], LPointer[Any]) => Int)]], userData: Rep[Any]) extends FunctionDef[Int](None, "LGHashTableHeader.g_hash_table_foreach_remove", List(List(ht, pred, userData))) {
    override def curriedConstructor = (copy _).curried
  }

  case class LGHashTableHeaderG_hash_table_get_keysObject(ht: Rep[LPointer[LGHashTable]]) extends FunctionDef[LPointer[LGList[Any]]](None, "LGHashTableHeader.g_hash_table_get_keys", List(List(ht))) {
    override def curriedConstructor = (copy _)
  }

  case class LGHashTableHeaderG_hash_table_get_valuesObject(ht: Rep[LPointer[LGHashTable]]) extends FunctionDef[LPointer[LGList[Any]]](None, "LGHashTableHeader.g_hash_table_get_values", List(List(ht))) {
    override def curriedConstructor = (copy _)
  }

  // method definitions
  def lGHashTableHeaderG_hash_table_newObject(hash: Rep[LPointer[(LPointer[Any] => Int)]], equals: Rep[LPointer[((LPointer[Any], LPointer[Any]) => Int)]]): Rep[LPointer[LGHashTable]] = LGHashTableHeaderG_hash_table_newObject(hash, equals)
  def lGHashTableHeaderG_hash_table_insertObject(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]], value: Rep[LPointer[Any]]): Rep[Unit] = LGHashTableHeaderG_hash_table_insertObject(ht, key, value)
  def lGHashTableHeaderG_hash_table_replaceObject(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]], value: Rep[LPointer[Any]]): Rep[Unit] = LGHashTableHeaderG_hash_table_replaceObject(ht, key, value)
  def lGHashTableHeaderG_hash_table_sizeObject(ht: Rep[LPointer[LGHashTable]]): Rep[Int] = LGHashTableHeaderG_hash_table_sizeObject(ht)
  def lGHashTableHeaderG_hash_table_lookupObject(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]]): Rep[LPointer[Any]] = LGHashTableHeaderG_hash_table_lookupObject(ht, key)
  def lGHashTableHeaderG_hash_table_lookup_extendedObject(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]], origKey: Rep[LPointer[Any]], value: Rep[LPointer[Any]]): Rep[Int] = LGHashTableHeaderG_hash_table_lookup_extendedObject(ht, key, origKey, value)
  def lGHashTableHeaderG_hash_table_foreachObject(ht: Rep[LPointer[LGHashTable]], func: Rep[LPointer[((LPointer[Any], LPointer[Any], LPointer[Any]) => Unit)]], userData: Rep[Any]): Rep[Unit] = LGHashTableHeaderG_hash_table_foreachObject(ht, func, userData)
  def lGHashTableHeaderG_hash_table_findObject(ht: Rep[LPointer[LGHashTable]], pred: Rep[LPointer[((LPointer[Any], LPointer[Any], LPointer[Any]) => Int)]], userData: Rep[Any]): Rep[LPointer[Any]] = LGHashTableHeaderG_hash_table_findObject(ht, pred, userData)
  def lGHashTableHeaderG_hash_table_removeObject(ht: Rep[LPointer[LGHashTable]], key: Rep[LPointer[Any]]): Rep[Int] = LGHashTableHeaderG_hash_table_removeObject(ht, key)
  def lGHashTableHeaderG_hash_table_remove_allObject(ht: Rep[LPointer[LGHashTable]]): Rep[Unit] = LGHashTableHeaderG_hash_table_remove_allObject(ht)
  def lGHashTableHeaderG_hash_table_foreach_removeObject(ht: Rep[LPointer[LGHashTable]], pred: Rep[LPointer[((LPointer[Any], LPointer[Any], LPointer[Any]) => Int)]], userData: Rep[Any]): Rep[Int] = LGHashTableHeaderG_hash_table_foreach_removeObject(ht, pred, userData)
  def lGHashTableHeaderG_hash_table_get_keysObject(ht: Rep[LPointer[LGHashTable]]): Rep[LPointer[LGList[Any]]] = LGHashTableHeaderG_hash_table_get_keysObject(ht)
  def lGHashTableHeaderG_hash_table_get_valuesObject(ht: Rep[LPointer[LGHashTable]]): Rep[LPointer[LGList[Any]]] = LGHashTableHeaderG_hash_table_get_valuesObject(ht)
