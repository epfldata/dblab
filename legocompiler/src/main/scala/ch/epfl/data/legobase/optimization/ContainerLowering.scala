...
class ContainerLowering[Lang <: pardis.deep.scalalib.ArrayComponent with pardis.deep.scalalib.Tuple2Component with ContOps](override val IR: Lang) extends pardis.optimization.RecursiveRuleBasedTransformer[Lang](IR)
