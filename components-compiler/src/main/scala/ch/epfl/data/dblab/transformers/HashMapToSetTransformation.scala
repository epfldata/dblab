 ...
 */
class HashMapToSetTransformation(override val IR: QueryEngineExp, val schema: Schema)
...
class HashMapToSetWithMallocTransformation(override val IR: QueryEngineExp, val schema: Schema)
