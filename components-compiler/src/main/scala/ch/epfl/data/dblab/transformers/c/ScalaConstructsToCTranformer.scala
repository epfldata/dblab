 ...
 */
class ScalaConstructsToCTranformer(override val IR: QueryEngineExp, val ifAgg: Boolean) extends RecursiveRuleBasedTransformer[QueryEngineExp](IR) with CTransformer {
  import IR._
  import CNodes._
  import CTypes._
