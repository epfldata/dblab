 ...
 */
class GenericEngineToCTransformer(override val IR: QueryEngineExp, val settings: CTransformersPipelineSettings) extends RuleBasedTransformer[QueryEngineExp](IR) {
  import IR._
  import CNodes._
  import CTypes._
