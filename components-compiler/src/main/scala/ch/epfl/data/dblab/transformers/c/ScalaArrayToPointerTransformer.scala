 ...
 */
class ScalaArrayToPointerTransformer(override val IR: QueryEngineExp, val settings: CTransformersPipelineSettings) extends RuleBasedTransformer[QueryEngineExp](IR) with CTransformer {
  import IR._
  import CNodes._
  import CTypes._
