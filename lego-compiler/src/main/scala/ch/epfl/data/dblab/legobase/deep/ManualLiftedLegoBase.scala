...
trait ManualLiftedLegoBase extends OrderingOps with ManifestOps with sc.pardis.deep.scalalib.collection.RichIntOps with sc.pardis.deep.scalalib.ByteComponent with LegoHashMap with LegoArrayBuffer with sc.pardis.deep.scalalib.collection.ContOps with sc.pardis.deep.scalalib.ScalaPredef { this: DeepDSL =>
