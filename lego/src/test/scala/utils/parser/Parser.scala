...
class ParserSpec extends FlatSpec {
  ...
  "Parser" should "parse Q2 correctly" in {
    val parser = Parser
    val r = parser.parse(Queries.q2)
    r should not be None
  }

  "Parser" should "parse Q3 correctly" in {
    val parser = Parser
    val r = parser.parse(Queries.q3)
    r should not be None
  }

  "Parser" should "parse Q4 correctly" in {
    val parser = Parser
    val r = parser.parse(Queries.q4)
    r should not be None
  }

  "Parser" should "parse Q5 correctly" in {
    val parser = Parser
    val r = parser.parse(Queries.q5)
    r should not be None
  }

  "Parser" should "parse Q6 correctly" in {
    val parser = Parser
  ...
  "Parser" should "parse LIMIT correctly" in {
    val parser = Parser
